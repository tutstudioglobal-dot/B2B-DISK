...
export default async function handler(req, res) {
  ...
  const connectionString = `postgresql://postgres:${encodeURIComponent(password)}@aws-0-eu-west-1.pooler.supabase.com:6543/postgres?options=reference%3D${encodedRef}`;
